...
import com.example.dam_android.data.api.dto.ForgotPasswordRequest
import com.example.dam_android.data.api.dto.LoginRequest
import com.example.dam_android.data.api.dto.RegisterRequest
import com.example.dam_android.data.api.dto.ResetPasswordRequest
import com.example.dam_android.data.api.dto.UpdateUserRequest
import com.example.dam_android.data.api.dto.VerificationRequest
import com.example.dam_android.data.api.dto.UserResponse
...
object ApiService {
    ...
    suspend fun updateUser(userId: String, firstName: String?, lastName: String?, phoneNumber: String?, password: String?): Result<User> {
        return try {
            ...
            Result.failure(Exception("Délai d'attente dépassé"))
